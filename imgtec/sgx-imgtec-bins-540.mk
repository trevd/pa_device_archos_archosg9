# Graphics/IMGTEC
SGX_LOCAL_PATH := device/archos/archos_g9/imgtec

# External SGX Module
SGX_MODULES:
	make clean -C device/archos/archos_g9/pvr-source/eurasiacon/build/linux2/omap4430_android
	cp kernel/archos/archos_g9/drivers/video/omap2/omapfb/omapfb.h $(KERNEL_OUT)/drivers/video/omap2/omapfb/omapfb.h
	make -j8 -C device/archos/archos_g9/pvr-source/eurasiacon/build/linux2/omap4430_android ARCH=arm KERNEL_CROSS_COMPILE=arm-eabi- CROSS_COMPILE=arm-eabi- KERNELDIR=$(KERNEL_OUT) TARGET_PRODUCT="blaze_tablet" BUILD=release TARGET_SGX=540 PLATFORM_VERSION=4.0
...
# Graphics
PRODUCT_COPY_FILES += \
    $(SGX_LOCAL_PATH)/lib/hw/gralloc.omap4430.so:/system/vendor/lib/hw/gralloc.archos.so \
    $(SGX_LOCAL_PATH)/lib/hw/gralloc.omap4430.so:/system/vendor/lib/hw/gralloc.omap4430.so \
    $(SGX_LOCAL_PATH)/lib/hw/gralloc.omap4430.so:/system/vendor/lib/hw/gralloc.omap4460.so \
    ...
    $(SGX_LOCAL_PATH)/lib/omaplfb_sgx540_120.ko:/system/lib/omaplfb_sgx540_120.ko \
